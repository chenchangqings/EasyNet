...
//            defaultHttpConfig = new DefaultHttpConfig();
//            defaultHttpConfig.okGoInit(context); //初始化okGo和HttpClient
//        }
//    }
//
//
...
//
//    //默认转换成callBack指定的范型
//    public <T> void requestModel(Context tag, Enum method,String path,HttpParams params,ModelCallback<T> callback){
//        requestModel(tag,method,path,params,callback.getGenericClass(),callback);
//    }
//
//
//    /**
...
//     * @param <T>，Model泛型
//     */
//    public <T> void requestModel(final Context tag, Enum method,String path, HttpParams params,final Class<T> tClass,final com.android.ccq.easynet.callback.ModelCallback<T> callback) {
//        if (!commonPrepare(callback)) return;
//
//        getCallBack(tag,method,path,params,new com.lzy.okgo.callback.StringCallback() {
//            @Override
